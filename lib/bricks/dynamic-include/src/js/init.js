...
$(function () {
  ...
  addNodeDecoratorByData(LINK_BASE_CONFIG, "hash-based-fragment-link", function ($link, linkConfig) {
    new Link($link, linkConfig);
  });

  // handle hashBasedFragmentForms
  addNodeDecoratorByData(FORM_BASE_CONFIG, "hash-based-fragment-form", function ($form, formConfig) {
