  ...
  return yargs
    ...
    .check((argv) => {
      const checks = [
        {
          key: "Studio URL",
          value: typeof argv.studioUrl === "undefined" || isValidURL(argv.studioUrl),
        },
        {
          key: "Open Browser",
        ...
        {
          key: "Preview URL",
          value: typeof argv.previewUrl === "undefined" || isValidURL(argv.previewUrl),
        },
        {
          key: "Proxy URL",
          value: typeof argv.proxyUrl === "undefined" || isValidURL(argv.proxyUrl),
        },
        {
          key: "Username",
          value: typeof argv.username === "undefined" || isValidStringValue(argv.username),
        },
        {
          key: "Password",
          value: typeof argv.password === "undefined" || isValidStringValue(argv.password),
        },
      ];
    ...
    inquirer
      ...
      .then((args) => {
        themeImporter
          ...
          .then(getSuccessfulLoginHandler(log, args.openBrowser, args.studioUrl, args.proxyUrl))
          .catch((e) => {
            log.error(e.message);
            process.exit(1);
          });
...
const getSuccessfulLoginHandler =
  (log, openBrowser, studioClientUrl, proxyUrl) =>
