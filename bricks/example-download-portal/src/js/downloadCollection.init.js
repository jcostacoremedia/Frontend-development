...
$(function () {
  ...
  nodeDecorationService.addNodeDecoratorBySelector(".am-overlay__close-button", function ($closeButton) {
    ...
    function ($addToDownloadCollectionBtn, config) {
      $addToDownloadCollectionBtn.on("click", function (event) {
        ...
        if (!$(this).attr("disabled")) {
          ...
          updateLeftBadgeIcon(
            $(this).closest(".am-asset-teaser").find(".am-picture-box__badge-icon-left"),
            hasRenditions,
          );
        }
      });
      ...
      $buttons.on("click", function (event) {
        ...
        $.ajax({
          ...
          .fail(function (response) {
            logger.error("Failed to prepare download: ", response.responseText);
          });
        return false;
      });
    },
  ...
  nodeDecorationService.addNodeDecoratorByData(
    ...
    function ($collectionOverview, config, state) {
      function refresh() {
        ...
        updateTargetWithAjaxResponse($collectionOverview, requestConfig, false, undefined);
      }
      $.extend(state, {
        windowListener: function () {
