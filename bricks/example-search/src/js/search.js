 ...
 */
export function loadSearchResultPage(link, searchResultPageId = "cm-search-results-page", enableBrowserHistory = true) {
  if (link) {
...
function addToBrowserHistory(link, enableBrowserHistory) {
  if (enableBrowserHistory) {
    ...
    window.history.pushState({ id: "search", link: link }, "", removeURLParameter(link, "view"));
  }
}
